...
<table border="1px solid white">
    <tr>
        <td>Language</td>
        <td>
            <img src="https://skillicons.dev/icons?i=js,python,php,cs" width="200" height="auto" alt="Language" title="JavaScript, Python, PHP, C#"/>
        </td>
    </tr>
    <tr>
        <td>Mobile</td>
        <td>
            <img src="https://skillicons.dev/icons?i=java,kotlin,androidstudio,react" width="200" height="48" alt="Mobile" title="Java, Kotlin, Android Studio, React Native">
        </td>
    </tr>
    <tr>
        <td>Frontend</td>
        <td>
            <img src="https://skillicons.dev/icons?i=html,css,vite,react" width="200" height="auto" alt="Frontend" title="HTML, CSS, Vite, React JS"/>
        </td>
    </tr>
    <tr>
        <td>Framework</td>
        <td>
            <img src="https://skillicons.dev/icons?i=django,electron,net,nodejs" width="200" height="auto" alt="Framework" title="Django, Electron, .NET, Node JS"/>
        </td>
    </tr>
    <tr>
        <td>Database</td>
        <td>
            <img src="https://skillicons.dev/icons?i=firebase,supabase,sqlite,mysql" width="200" height="48" alt="Database" title="Firebase, Supabase, SQLite, MySQL"/>
        </td>
    </tr>
    <tr>
        <td>Tools</td>
        <td>
            <img src="https://skillicons.dev/icons?i=powershell,git,github,npm" width="200" height="48" alt="Tools" title="CLI, Git, Github, NPM"/>
        </td>
    </tr>
</table>
...
<table>
    <tr>
        <td>
            <img src="https://play-lh.googleusercontent.com/b_zo6DlIrdQ28yF2wN7A9nh3J6rsdFDA0SO6i-p1fiXNhL3MA6_AncqfZ_ih1_rLYqPBrOUQqDG3qh7VQBdzBg=w5120-h2880-rw" width="500">
        </td>
        <td>
    ...
    <tr>
        <td>
            <img src="images/deepfake_cover.png" width="500">
        </td>
        <td>
    ...
    <tr>
        <td>
            <img src="https://linkhub-app.onrender.com/images/app/logo.png" width="500">
        </td>
        <td>
